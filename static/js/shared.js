...
function hideUploadPrompt(){
	document.getElementById('uploadFrame').contentDocument.location = '/convert';
	document.getElementById('uploadFrame').contentDocument.location.reload(true);
...
function exportScripts(){
	...
	for (var i=0; i<exports.length; i++){
		...
		url = '/export?resource_id=' + id + '&export_format=' + format;
		window.open(url);
	}
	hideExportPrompt();
}
